...
RSpec.describe SurveysController, type: :routing do
  describe "routing" do
    ...
    it "routes to #results" do
      expect(:get => "/results").to route_to("surveys#results")
    end

    it "routes to #tab_results" do
      expect(:get => "/tab_results").to route_to("surveys#results")
    end

    it "routes to #tab_results" do
      expect(:post => "/tab_results").to route_to("surveys#tab_results")
    end
